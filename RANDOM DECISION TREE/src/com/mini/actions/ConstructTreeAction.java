...
public class ConstructTreeAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Vector vcb = null;
		try {
			vcb = new UserdaoImpl().viewSelectedData(rto);
		...
		if (!vcb.isEmpty()) {
			...
			request.setAttribute("status", "Selected Criteria and Results are ");
			path = "./SelectedTreeDetails.jsp";
		} else {

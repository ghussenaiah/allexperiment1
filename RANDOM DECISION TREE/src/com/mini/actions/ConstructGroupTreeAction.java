...
public class ConstructGroupTreeAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Vector vcb = null;
		try {
			vcb = new UserdaoImpl().viewSelectedGroupData(rto);
		...
		if (!vcb.isEmpty()) {
			...
			request.setAttribute("status", "Selected Criteria and Results are  for Groups");
			path = "./SelectedTreeGroupDetails.jsp";
		} else {

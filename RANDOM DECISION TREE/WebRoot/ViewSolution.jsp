...
<body background="./images/bbgg2.jpg">
    ...
    <jsp:include page="Header.jsp"></jsp:include>
			...
			<center><h2><font color=child>Reply from Admin</h2></center>
		  <div class="hr"> </div>
		  
					  <table width="381" border="1" align="center" background="./images/b12.jpeg" width="400">
              ...
              <td width="286"><label>
                            <input type="text" name="from"  size="48" value="${Solutionvector.from }" readonly="readonly" />
                          </label></td>
                        </tr>
                        <tr>
                          <td><span class="">To</span></td>
                          <td><label>
                            <input type="text" name="to"  size="48"  value="" readonly="readonly"/>
                          </label></td>
                        </tr>
                        <tr>

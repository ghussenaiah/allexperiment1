...
.Title1 {
	...
	<body background="./images/gb2.jpg">
		...
		<form action="./UpdateUserProfileAction" method='post' name="register"
			...
			<table border='0' align="center">
				...
				<tr>
					...
					<td>
						<input type="text" name="username"
							value="<%=pro.getUsername()%>" readonly />
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="firstname"
							value="<%=pro.getFirstname()%>" size="20" readonly />
					</td>
				...
				<tr>
					...
					<td width='256'>
						...
						<input type="text" name="dob"
							value="<%=pro.getDob()%>" size="20" readonly="readonly" />
				...
				<tr>
					...
					<td>
						<input type="text" name="phoneNo" value="<%=pro.getCl()%>"
							size="20" readonly />
					</td>

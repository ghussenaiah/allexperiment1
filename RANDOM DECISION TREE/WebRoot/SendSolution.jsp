...
-->
    ...
    </head><body background="./images/gb2.jpg">
    	
<jsp:include page="Header.jsp"></jsp:include>
    
	
			<center><h2><font color=yellow>Reply Form</h2></center>
		  <div class="hr"> </div>
          <p></p> 
            ...
            String  reportDate = df.format(date); 
             %>
					  ...
					  <table width="381" border="1" align="center" background="./images/b33.jpeg">
              ...
              <td width="286"><label>
                            <input type="text" name="qid" size="48" value="${Querysolution.qid }" readonly="readonly" />
                          </label><br></td>
                        </tr>
              ...
              <td width="286"><label>
                            <input type="text" name="from" size="48" value="Admin" readonly="readonly" />
                          </label><br></td>
                        </tr>
                        <tr>
                          <td><span >To</span><br></td>
                          <td><label>
                            <input type="text" name="to"  size="48"  value="User" readonly="readonly"/>
                          </label><br></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="sdate"   readonly="readonly" value="${Querysolution.qdate }"/><br></td>
                        </tr>

...
case 23:
        ...
        float subtractValue123mtemp = sampleCrunchifyHelloWorldProxyid.subtractValue1(value_3idTemp);
        String tempResultreturnp24 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(subtractValue123mtemp));
        %>
        <%= tempResultreturnp24 %>
        <%
break;
